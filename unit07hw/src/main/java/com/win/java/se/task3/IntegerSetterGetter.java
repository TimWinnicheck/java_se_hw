    ...
    private void getIntegersFromResource() throws InterruptedException {
        ...
        synchronized (resource) {
            ...
            while (number == null) {
                ...
                resource.wait(1000); //timeout added to prevent endless waiting
                System.out.println("Поток " + getName() + " возобновил работу.");
                number = resource.getElement();
                if (number == null) setIntegersIntoResource(); //added to put integers in if the number is still null
            }
